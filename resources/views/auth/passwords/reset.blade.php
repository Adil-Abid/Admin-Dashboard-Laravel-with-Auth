                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Reset password with ERPSystem</p>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="email" class="form-control @error('email') is-invalid @enderror" id="useremail" name="email" placeholder="Enter email" value="{{ $email ?? old('email') }}" id="email">
                                            @error('email')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> ERPSystem. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Zeta</p>
                        </div>
                    </div>
                </div>
            </div>
